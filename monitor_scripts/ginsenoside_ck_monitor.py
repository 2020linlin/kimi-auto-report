...
KEYWORDS = {
    "生物合成-中文": ["人参皂苷CK 生物合成", "人参皂苷CK 酵母合成", "人参皂苷Compound K 微生物合成"],
    "生物合成-英文": ["Ginsenoside CK biosynthesis", "Ginsenoside Compound K yeast", "Ginsenoside CK synthetic biology"],
    "合成途径-中文": ["人参皂苷CK 合成途径", "人参皂苷CK 达玛烷型", "原人参二醇 人参皂苷CK"],
    "合成途径-英文": ["Ginsenoside CK biosynthetic pathway", "Ginsenoside CK dammarane", "Protopanaxadiol ginsenoside CK"],
    "酶工程-中文": ["人参皂苷CK 糖基转移酶", "人参皂苷CK β-葡萄糖苷酶"],
    "酶工程-英文": ["Ginsenoside CK glycosyltransferase", "Ginsenoside CK β-glucosidase"],
    "发酵优化-中文": ["人参皂苷CK 发酵产量", "人参皂苷CK 滴度"],
    "发酵优化-英文": ["Ginsenoside CK fermentation titer", "Ginsenoside CK yield optimization"],
...
def analyze(category, articles):
    ...
    prompt = f"""你是天然产物合成生物学专家，分析人参皂苷CK【{category}】文献：
...
人参皂苷CK：达玛烷型三萜，PPD→CK，关键酶OSC、P450、UGT。"""
